...
![Quality Check – Example T1w Image](results_figures/step01_quality_check_T1w.png)
...
![Skull-Stripped Image](results_figures/step02_skull_stripped.png)
...
![Bias Correction Comparison](results_figures/step03d_bias_correction_comparison.png)
...
![MNI152 Template](results_figures/step04a_mni152_template.png)

*The MNI152 T1-weighted template used as the registration target.*

![Normalized MRI – 3 Views](results_figures/step04b_normalized_mri_3views.png)
...
![Gray Matter Segmentation](results_figures/step05_gray_matter_segmentation.png)
...
![Smoothing and Refinement](results_figures/step06_smoothing_refinement.png)
...
![Segmentation 3 Views](results_figures/step07_segmentation_3views_sub-B06.png)

*Sagittal, coronal, and axial views of the tissue segmentation for subject sub-B06 (bipolar).*

![Segmentation Overlay](results_figures/step08_segmentation_overlay.png)
...
![Tissue Labels 3 Views](results_figures/step09_tissue_labels_3views.png)

*Three-plane view of the tissue label map (GM=light, WM=white, CSF=dark) across sagittal, coronal, and axial planes.*

![Brain Mask Overlay](results_figures/step10_brain_mask_overlay.png)
